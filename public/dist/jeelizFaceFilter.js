  ...
  window.JEELIZFACEFILTERGEN = function () {
    ...
    function ub(a) {
      ...
      a =
        "undefined" === typeof btoa
          ...
          : atob(a);
      for (var c = a.length, d = new Uint8Array(c), h = 0; h < c; ++h)
        d[h] = a.charCodeAt(h);
      return d;
    }
    function gb(a) {
      ...
      if ("undefined" === typeof gb(a).nb) {
        ...
        for (
          ...
          var l = q * n,
            ...
            w = tb(c, l + 1, a);
          l = l + 1 + a;
          for (var y = p.length, x = 0, r = l; r < l + y; ++r)
            (p[x] = fb(c, r, !0)), ++x;
          for (y = l = 0; y < d; ++y) l += p[y] * Math.pow(2, -y - 1);
          k[n] =
            0 === l && 0 === w
              ? 0
              : t * (1 + l) * Math.pow(2, 1 + w - Math.pow(2, a - 1));
        }
        a = k;
    ...
    function Ob() {
      ...
      return ba.enableAsyncReadPixels
        ? Y.Mb(0, 0, 3, 2 * a, V.buffer, xb, 1)
        : Y.be(0, 0, 3, 2 * a, V.buffer);
    }
    function vb() {
      na !== ja.pause &&
    ...
    function Pb() {
      ...
      if (!J.Ab)
        if (J.zb)
          J.element.needsUpdate &&
            (J.D.ie(J.element.videoWidth, J.element.videoHeight),
            J.D.Sb(J.element.arrayBuffer),
            (J.element.needsUpdate = !1));
        else {
    ...
    function xb() {
      sa.sg();
      ba.isCleanGLStateAtEachIteration &&
        (sa.reset(), aa.reset(), b.enable(b.DEPTH_TEST));
      S.Wb && S.Wb(da.Nd() ? Ca : Ca[0]);
      ba.isCleanGLStateAtEachIteration &&
        (b.disable(b.BLEND), Q.reset(), Q.Ca());
    }
    function Qb() {
      for (var a = 0; a < da.qa(); ++a)
        if (da.Jf(a)) {
          ...
          d.y = Fa(0, q, 2, -1, 1);
          d.ca = Fa(0, q, 3, 0, 1);
          if (d.kb < ba.multiDetectionThresholdFactors[0] * ba.threshold)
            (d.ua = Math.floor(d.ua / 2)), S.Ea && ((k.rz = 0), (k.ry = 0));
          else {
            var n = V.bb;
            ...
            h =
              (1 -
                $a.Fb(
                  ta.translationFactorRange[0],
                  ta.translationFactorRange[1],
                  Math.sqrt(h.dx * h.dx + h.dy * h.dy + h.ec * h.ec) / n
                )) *
              (1 -
                $a.Fb(
                  ta.rotationFactorRange[0],
                  ta.rotationFactorRange[1],
                  Math.sqrt(h.bc * h.bc + h.cc * h.cc + h.dc * h.dc) / n
                )) *
            ...
            k.rz = S.Ea
              ? k.rz + ta.followZRotAlphaFactor * p * d.xa
              : wa.aa(k.rz, d.xa, p);
            ...
            p = Math.max(p, ea.ye);
            for (c = 0; c < V.ba; ++c)
              k.expressions[c] = wa.aa(k.expressions[c], d.rd[c], p);
            ++d.ua;
          }
        }
    }
    ...
    function Vb() {
      ...
      da.Nd() &&
        (h && ((d = 0), (Sa[a].ua = 0), (c.isDetected = !1), (c.detected = 0)),
        D.I("u51", d));
      D.gg("u47", Ta.get(a));
      Q.l(!1, !1);
      if (da.Md() || h)
        b.viewport(1, a, 1, 1), D.set("s66"), D.I("u51", d), Q.l(!1, !1);
    ...
    function Cb() {
      var a = {
        ...
        Ga: J.element.videoHeight || J.element.height,
      };
      if (!a.w || !a.Ga || 4 > a.w || 4 > a.Ga)
        throw Error(
          "INVALID VIDEO DIMENSIONS - width = " + a.w + " height = " + a.Ga
        );
      return a;
    }
    function nb() {
    ...
    var wa = {
        ...
        var p = null,
          ...
          x = {
            ...
            rh: function () {
              ...
              for (
                var r = x.ef(),
                  F = n.createImageData(q.width, q.height),
                  C = q.width,
                  f = q.height,
                  E = F.data,
                  K = 0;
            ...
            A: function (r) {
              ...
              r.la
                ? ((b = r.la), (p = r.la.canvas))
                : r.fd && !r.jb
                ? (p = document.getElementById(r.fd))
                : r.jb && (p = r.jb);
              ...
              if (b) l = b instanceof WebGL2RenderingContext;
                ...
                b
                  ? (l = !0)
                  : ((b = p.getContext("webgl", F)) ||
                      (b = p.getContext("experimental-webgl", F)),
                    (l = !1));
              }
              if (!b) return a("WebGL1 and 2 are not enabled");
              r.zc &&
                p.addEventListener &&
                ((w = r.zc), p.addEventListener("webglcontextlost", w, !1));
          ...
          N = {
            ...
            instance: function (e) {
              ...
              function M(G) {
                ...
                R !== b.NO_ERROR &&
                  ha !== b.RGBA &&
                  ((ha = b.RGBA), b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, G));
                return !0;
              }
              function P() {
                if (!Eb) {
                  ...
                  B.isPot
                    ? (b.texParameteri(
                      ...
                      b.texParameteri(
                        b.TEXTURE_2D,
                        b.TEXTURE_WRAP_T,
                        B.isMirrorY ? b.MIRRORED_REPEAT : b.REPEAT
                      ))
                    : (b.texParameteri(
                        b.TEXTURE_2D,
                        b.TEXTURE_WRAP_S,
                  ...
                  B.isAnisotropicFiltering &&
                    ...
                    b.texParameterf(
                      b.TEXTURE_2D,
                      JEContext.sh().TEXTURE_MAX_ANISOTROPY_EXT,
                      JESETTINGS.yg
                    );
                  b.texParameteri(
                    b.TEXTURE_2D,
                    b.TEXTURE_MAG_FILTER,
                    B.isLinear ? b.LINEAR : b.NEAREST
                  );
                  var G = B.isMipmap && !Qa;
                  b.texParameteri(
                    b.TEXTURE_2D,
              ...
              var ca = {
                ...
                ke: function (G) {
                  b.TEXTURE_MAX_LEVEL &&
                    b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAX_LEVEL, G);
                },
                bf: function (G) {
                  G || (G = ca.xd());
                  if (Qa) {
                ...
                refresh: function () {
                  ...
                  Gb
                    ? b.texImage2D(b.TEXTURE_2D, 0, ka, ha, ia, B.J)
                    : b.texImage2D(b.TEXTURE_2D, 0, ka, T, U, 0, ha, ia, va);
                  Ba && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1);
                },
                ae: function () {
                  Wa || ua();
                ...
                gd: function (G) {
                  ...
                  if (G)
                    b.viewport(0, 0, T, U),
                      D.hg("u15", 0.25, 0.25, 0.25, 0.25),
                      ma.l(!1, !0);
                  else
                    for (G = 0; 4 > G; ++G)
                      b.viewport(0, U * G, T, U),
                        D.le("u15", g[G]),
                        ma.l(!1, 0 === G);
                },
                Sb: function (G) {
                  ...
                  if ("RGBA" === G || "RGBE" === G || "RGBAARRAY" === G) {
                    ...
                    if (R)
                      (W = new Float32Array(la)),
                        b.viewport(0, 0, T, U),
                        ma.l(!0, !0),
                        b.readPixels(0, 0, T, U, b.RGBA, b.FLOAT, W);
                    else {
                      for (W = 0; 4 > W; ++W)
                        b.viewport(0, U * W, T, U),
                          D.le("u15", g[W]),
                          ma.l(!W, !W);
                      ca.ae();
                      W = Array(la);
                ...
                B.array
                  ? (B.S && !B.isFloat
                      ...
                      : ((va = B.isFloat
                        ...
                        P()),
                    B.isKeepArray ||
                      (va && va !== B.array && (va = null), delete B.array))
                  : B.lc
                  ? (Ua = !0)
                  : P();
              ca.Ch = ca.K;
        ...
        var c = null,
          ...
          n = {
            ...
            instance: function (l) {
              ...
              b.bufferData(
                b.ARRAY_BUFFER,
                l.da instanceof Float32Array ? l.da : new Float32Array(l.da),
                y
              );
              p = t;
              var r = null,
              ...
              if (l.indices) {
                ...
                65536 > l.indices.length
                  ? ((f = Uint16Array), (F = b.UNSIGNED_SHORT), (C = 2))
                  : ((f = Uint32Array), (F = b.UNSIGNED_INT), (C = 4));
      ...
      Y = (function () {
        ...
        function h(g) {
          if (0 === f.ra.length) {
            ...
            f.ra.splice(0);
            f.ub.splice(0);
            for (var u = 0; u < f.Ta; ++u)
              f.ra.push(b.createBuffer()), f.ub.push(-1);
            f.ja = 0;
            f.xc = 0;
          }
          b.bindBuffer(f.X, f.ra[f.ja]);
          g.byteLength !== f.ub[f.ja] &&
            (b.bufferData(f.X, g.byteLength, b.STREAM_READ),
            (f.ub[f.ja] = g.byteLength));
          f.Ih = !0;
        }
        function k() {
          ...
          z = {
            A: function () {
              ...
              if (!w.Hd) {
                ...
                if (w.Ld || z.na())
                  (w.Qc = z.qd(g)), (A.GL_EXT_HALFFLOATLINEAR = w.Qc);
                w.Jh = w.Qc ? !0 : !1;
                w.Hd = !0;
              }
              w.Xb = z.md(g);
            ...
            Re: function () {
              ...
              u.v();
              z.flush();
              b.checkFramebufferStatus(oa.kf()) !== b.FRAMEBUFFER_COMPLETE
                ? (za.cg(), (x.hc = !1))
                : (x.hc = !0);
              g.remove();
              u.remove();
                  ...
                  switch (b.clientWaitSync(f.Fa[P], 0, 0)) {
                    ...
                    default:
                      return (
                        ...
                        b.deleteSync(f.Fa[P]),
                        (f.Fa[P] = null),
                        b.bindBuffer(f.X, f.ra[P]),
                        b.getBufferSubData(f.X, 0, v),
                        k(),
                        q(),
                        m(v, e),
                        !0
      ...
      Aa = (function () {
        ...
        function c(g, u) {
          return E.ka && a(g, f.FLOAT, new Float32Array(y), u)
            ? ((n = q.Yc), !0)
            : !1;
        }
        function d(g, u, I) {
          ...
          var L = za.Ne(y),
            v = Y.ob(f);
          if (
            (v && v.HALF_FLOAT_OES && a(g, v.HALF_FLOAT_OES, L, u)) ||
            (f.HALF_FLOAT && a(g, f.HALF_FLOAT, L, u))
          )
            return (n = q.Oa), !0;
      ...
      Lb = (function () {
        return {
          instance: function (a) {
            ...
            a.mask &&
              ((h = !0),
              ea && void 0 !== ea.Ae && (a.mask = ea.Ae + a.mask),
        ...
        return {
          instance: function (a) {
            ...
            var k = {
              ...
              y = [a.Ya ? "s32" : "s31", a.Ya ? "s34" : "s33", "s35"][
                a.shiftRGBAMode || 0
              ],
              x = { isEnabled: !1 },
              r = 1 / a.size;
            a.Ef
              ? ((a.sparsity =
                  "undefined" !== typeof a.sparsity ? a.sparsity : a.Kb.kc()),
                (q = !1))
            ...
            var g = {
              ...
              dg: function () {
                switch (a.connectivityUp) {
                  ...
                  case "full":
                    z = fc.instance(
                      Object.assign({ Ya: a.Ya }, a.connectivity)
                    );
                    break;
                  case "conv":
                    (l = a.kernelsCount),
              ...
              kg: function (u) {
                ...
                for (var I = 0, L = 0, v = 0; I < u; ++I)
                  n.buffer.push(L + (a.size - 1 - v) * a.size),
                    n.results.push([-1, -1, -1, -1]),
                    ++L,
                    L === a.size && ((L = 0), ++v);
                n.yb = "gpuRawAvg" === n.type || "cpuMeanFloat" === n.type;
                if (a.normalize || n.yb)
                  k.Cc = aa.instance({ isFloat: !0, isPot: !0, width: a.size });
              },
              Uf: function (u) {
                return u.Wf().then(h);
              },
            ...
            return {
              ...
              U: function (k) {
                if (k.isEnabled) {
                  ...
                  k.Lf.h(3);
                  for (
                    var p = Math.min(k.ab.length, k.depth), q = 0;
                    q < p;
                    ++q
                  )
                    k.ab[q].Ce(4 + q);
      ...
      bc = (function () {
        return {
          instance: function (a) {
            ...
            var d = Object.assign(
                { pa: 0.1, ga: 9, u: 128, gain: 1, Ec: 0, Za: !1, Z: !1 },
                a
              ),
              h = c(!1),
              k = null,
            ...
            if (a.video.width.ideal && a.video.height.ideal) {
              ...
              for (n.Aa = void 0; l < p.length; n = { Aa: n.Aa }, ++l) {
                ...
                for (t.sa = void 0; w < q.length; t = { sa: t.sa }, ++w)
                  if (
                    ((t.sa = q[w]),
                    n.Aa !== a.video.width.ideal ||
                      t.sa !== a.video.height.ideal)
                  ) {
            ...
            : new Promise(function (h, k) {
                if (a.srcObject && a.srcObject.getVideoTracks) {
                  ...
                  1 !== p.length
                    ...
                    : ((p = p[0]), c ? X.get(a, h, k, d) : (p.stop(), h()));
      ...
      qa = (function () {
        ...
        var c = {
          ...
          F = {
            ...
            nh: function (C) {
              return Math.pow(
                Math.min(Math.max(n, 0), h.n - 1) / (h.n - 1),
                C || 1
              );
            },
            A: function (C) {
            ...
            Qb: function (C) {
              ...
              C - p > h.tg &&
                ...
                (n =
                  n * (1 - f) +
                  (k < h.rb[0] ? l - 1 : k > h.rb[1] ? l + 1 : l) * f),
                Math.abs(n - l) > 1 - h.Sf &&
                  ((f = Math.min(Math.max(Math.round(n), 0), h.n - 1)),
                  f !== l && ((n = l = f), (k = (h.rb[1] - h.rb[0]) / 2))),
                (p = C));
            },
      ...
      Ma = (function () {
        ...
        function w(v) {
          var O = g.la,
            ...
            e = g.wb;
          e = g.Ja
            ? N.kh(e, N.QUERY_RESULT_AVAILABLE_EXT)
            : O.getQueryParameter(e, O.QUERY_RESULT_AVAILABLE);
            ...
            w(function (N) {
              if (N) {
                ...
                var e = g.vb,
                  m = g.wb;
                N = g.Ja
                  ? e.getQueryObjectEXT(m, e.QUERY_RESULT_EXT)
                  : N.getQueryParameter(m, N.QUERY_RESULT);
                v(N);
              } else O();
            });
          });
          ...
          L = {
            A: function (v) {
              ...
              if (null !== r.Uc) {
                ...
                if (
                  (O =
                    v.getExtension("EXT_disjoint_timer_query") ||
                    v.getExtension("EXT_disjoint_timer_query_webgl2"))
                ) {
                  g.la = v;
                  g.vb = O;
                  g.isEnabled = !0;
        ...
        return {
          A: function (y) {
            ...
            for (var E = 0; E < d.Vd; ++E) {
              ...
              g /= 2;
              for (
                var L = 1 + (1 - z - z) / u, v = 1 + (1 - g - g) / I, O = 0;
                O < v;
                ++O
              )
          ...
          reset: function () {
            for (var y = h.length / q.length, x = 0; x < q.length; ++x)
              q[x] = Math.floor(x * y);
            t = 0;
            l = h;
          },
      ...
      da = (function () {
          ...
          return f.some(function (u, I) {
            if (
              !(u =
                ...
                z.ua > u.ua ||
                3 > u.ua ||
                !(0 < a(z.x, z.ca * r, u.x, u.ca * r)) ||
                !(0 < a(z.y, z.ca * A * r, u.y, u.ca * A * r)))
            ) {
              u = F[I];
              g.scale > u.scale ? (I = g) : ((I = u), (u = g));
              for (var L = 0, v = 0, O = n.We, N = 0; N < O; ++N)
                for (
                  var e = (((N + 0.5) / O) * 2 - 1) * u.oa[1], m = 0;
                  m < O;
                  ++m
                ) {
        ...
        var q = { O: 1, Rd: 0.3, jd: [1, 1], We: 6, fe: 0.3, Fd: null, Ff: !0 },
          ...
          C = {
            ...
            Ue: function (f) {
              for (
                var E = new Float32Array(f.length * n.O), K = 0, A;
                K < n.O;
                ++K
              )
            ...
            return {
              L: function (l, t) {
                ...
                if ((n = d.Bf && t < 0.5 * l)) {
                  ...
                  q = l.D;
                  l.Qd !== t &&
                    ((w = Math.log2(t)), q.h(0), q.ke(w), za.M(0), (l.Qd = t));
                } else q = k;
                p = t;
                q.L();
              },
      ...
      sb = {
        ...
        init: function (a) {
          ...
          da.A({
            ...
            Fd: function (k) {
              return (
                k.detected > ba.multiDetectionThresholdFactors[1] * ba.threshold
              );
            },
          });
          for (d = 0; d < da.qa(); ++d)
            jb.push(new Float32Array(ea.Qf)), kb.push(0);
        ...
        toggle_videoStream: function (a) {
          return J.zb || !J.element
            ? Promise.resolve()
            : X.te(J.element, a, J.Sa);
        },
          ...
          Za() &&
            ...
            (a && !S.Bb
              ? ((S.Yd = S.ea),
                ...
                this.set_animateDelay(ea.xg),
                (S.Bb = !0))
              : !a &&
                S.Bb &&
                ((ba.nDetectsPerLoop = -1),
                this.set_animateDelay(S.Yd),
                (S.Bb = !1)));
        },
